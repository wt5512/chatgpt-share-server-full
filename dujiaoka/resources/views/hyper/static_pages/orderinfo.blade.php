...
<div class="row">
    <div class="col-12">
        <div class="page-title-box" style="display: flex;justify-content: space-between;align-items: center;">
            ...
            <button id="queryOrderStatusBtn" class="btn btn-outline-primary kami-btn" style="height: 40px;color: #fff;background-color: #146ebe;border-color: #146ebe;">
                重新获取订单状态
            </button>
        </div>
    </div>
...
<script>
	...
	document.addEventListener('DOMContentLoaded', (event) => {
	  const orderStatusButton = document.getElementById('queryOrderStatusBtn');
	  orderStatusButton.addEventListener('click', () => {
		queryOrderStatus(refreshPage);
	  });
	});
